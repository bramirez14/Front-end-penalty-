...
export const Vacaciones = () => {
  ...
  const{datosPeriodo,titulo}=periodo
...
let fechaActual= new Date();
    ...
    if(mes===mesFecha){
      ...
      let finVacaciones = fechaActual.toLocaleDateString();
        ...
        setVacaciones({ ...vacaciones,fechaDesde: newFormat, fechaHasta:finVacaciones,diasFaltantes:diasFaltantesFinales.toString()});
    }
    else{
      setVacaciones({ ...vacaciones,fechaDesde: newFormat,diasFaltantes:diasFaltantesFinales.toString()});
...
console.log(vacaciones);
    ...
    <Form className='form' noValidate validated={validated} >
      ...
      <Form.Row>
        ...
        <Form.Label style={{marginLeft:'30px'}}>Inicio de Vacaciones</Form.Label>
...
<Form.Row>
    ...
    <Form.Control as="textarea" placeholder='Mensaje' rows={4} name='obs' onChange={handleChange}/>
  </Form.Group>
